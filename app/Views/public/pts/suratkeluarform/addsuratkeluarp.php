...
<div class="container">
    ...
    <form action="<?= base_url('simpanSukerp'); ?>" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-6">
        ...
        <div class="row">
            <div class="mx-auto">
                <a href="<?= base_url('suratkeluarp'); ?>" type="button" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Kembali</a>
