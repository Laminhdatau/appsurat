                    ...
                    <?php foreach ($permissions as $p) : ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                foreach ($idArr as $i) { ?>
                                    <p>
                                        <button type="button" class="badge badge-danger delete-permission-btn" data-permission="<?= $i ?>" data-id="<?= $p['user_id']; ?>"><i class="fas fa-trash"></i></button>
                                    </p>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">HAK AKSES USER</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url('adduserpermission'); ?>" method="post">
    ...
    $(document).ready(function() {
        ...
        $('.delete-permission-btn').on('click', function() {
            ...
            if (confirm('Are you sure you want to delete this permission?')) {
                ...
                $.ajax({
                    url: 'removeuserpermission/' + userId + '/' + encodeURIComponent(permissionId),
                    type: 'POST',
