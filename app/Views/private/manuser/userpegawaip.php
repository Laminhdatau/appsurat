    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row align-items-center">
                <div class="col-11">
                    <h6 class="m-0 font-weight-bold text-primary">USER PEGAWAI PTS</h6>
                </div>
...
<div class="modal fade bd-example-modal-lg" id="tambahUserPegawai" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('adduserpegawaip'); ?>" method="post">
    ...
    $(document).ready(function() {
        ...
        $('.delete-level-btn').on('click', function() {
            ...
            if (confirm('Are you sure you want to delete this level?')) {
                ...
                $.ajax({
                    url: 'removeuserpegawaip/' + userId + '/' + encodeURIComponent(grupId),
                    type: 'POST',
